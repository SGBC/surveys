...
This is a pretty big dataset with multiple datastructures so we need to proceed carefully in terms of how we analyse data. We will use a number of different blocks to analyse different kinds of questions. Note: There is a bug creating a comma in numbers of column 11,not sure whyhea

#Information about the research of the respondents

```{r Respondent_data, echo=T, message=FALSE, warning=FALSE}

#Selecting columns from each dataset, harmonising column names and then harmonising response variables.
...
#gx.ks.test(respondentsSod21Pub$Q2, respondentsPig$Q2, ifresult = FALSE) #Kolmogorov-Smirnov test for Q2

unique(respondentsSoD21)
